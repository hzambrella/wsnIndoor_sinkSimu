        ...
        initPagenation: function(config) {
            ...
            var myPageConfig = {
                htmlTemp: [
                    ...
                    '<span class="pre-page text">prev</span>',
                    '<span class="first-page text">First</span>',
                    '<span class="last-page text">Last</span>',
                    '<span class="next-page text">next</span>',
                    '</span>'
                ].join(''),
                $pageBox: $pageBox,
                pageIndex: 1,
